...
<template>
    <div class="container">
        ...
        <!-- <VDivider></VDivider> -->
        <div class="login-bg">
            <SystemErrorAlert sytemErrorMessage="Something is wrong" v-if="form?.errors.length" />
                            ...
                            <VForm @submit.prevent="onSubmit">
                                <VRow class="login-field">
                                    ...
                                    <VCol cols="12">
                                        ...
                                        <VTextField variant="solo" v-model="form.email" type="email" class="bg-primary"
                                    ...
                                    <VCol cols="12">
                                        ...
                                        <VTextField variant="solo" v-model="form.password" :rules="[requiredValidator]"
        ...
        " />
                                        ...
                                        <span style="color: red; padding-top: 10px" v-if="props?.errorMessage">
                                            {{ props?.errorMessage }}
                                        </span>
                                        <div class="d-flex align-center flex-wrap justify-space-between mt-1 mb-4">
                                            <VCheckbox style="color: black !important" v-model="rememberMe"
                                                label="Remember me" />
                                        </div>
