...
onMounted(() => {
  ...
  form.allow_personalisation = props.plan?.allow_personalisation ? true : false;
      ...
      >
        <VRow justify="space-around" :gutter="10">
          ...
          <VCol cols="6">
            ...
            <VRow gutters="5">
              <VCol cols="8">
                <VLabel class="tiggie-label required">Plan Name</VLabel>
                <VTextField
              ...
              <VCol cols="8">
                <VLabel class="tiggie-label required">Description</VLabel>
                <VTextField
                  placeholder="Type here..."
                  density="compact"
              ...
              <VCol cols="8">
                <VLabel class="tiggie-label required">Price</VLabel>
                <VTextField
                  placeholder="Type here..."
                  density="compact"
                  type="number"
            ...
            <VRow>
              <VCol cols="8">
                ...
                <VTextField
                  ...
                  :rules="[requiredValidator]"
                  :error-messages="form?.errors?.num_student_profiles"
                />
              </VCol>
              <VCol cols="8">
                <VLabel class="tiggie-label required">Storage space</VLabel>
                <VTextField
                  placeholder="Type here..."
                  density="compact"
                  suffix="GB"
                  ...
                  :rules="[requiredValidator]"
                  :error-messages="form?.errors?.storage_limit"
                />
              </VCol>
              <VCol cols="8">
                <VRow no-gutters>
                  <VCol cols="6">
                    ...
                    <VSwitch v-model="form.allow_customisation" inset />
                  </VCol>
                  <VCol cols="6">
                    <VLabel class="tiggie-label">Personalization</VLabel>
                    <VSwitch v-model="form.allow_personalisation" inset />
                  </VCol>
                  <VCol cols="6">
                    <VLabel class="tiggie-label">Full Library Access </VLabel>
                    <VSwitch v-model="form.full_library_access" inset />
                  </VCol>
                  <VCol cols="6">
                    <VLabel class="tiggie-label">Concurrent Access</VLabel>
                    <VSwitch v-model="form.concurrent_access" inset />
                  </VCol>
                  <VCol cols="6">
                    <VLabel class="tiggie-label"
                      >Weekly Learning Report
                    </VLabel>
                    <VSwitch v-model="form.weekly_learning_report" inset />
                  </VCol>
                  <VCol cols="6">
                    <VLabel class="tiggie-label"
                      >Dedicated Student Report</VLabel
                    >
                    <VSwitch v-model="form.dedicated_student_report" inset />
                  </VCol>
                </VRow>
              </VCol>
            </VRow>
          ...
          <VCol cols="12" class="d-flex flex-wrap justify-center gap-10">
            ...
            <VBtn type="submit" class="" height="50" width="250"> Update </VBtn>
          </VCol>
        </VRow>
      </VForm>
    </VContainer>
