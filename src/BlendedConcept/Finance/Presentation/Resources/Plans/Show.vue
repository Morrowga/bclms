    ...
    <AdminLayout>
        <VContainer>
            <VRow justify="space-around" :gutter="5">
                <VCol cols="6">
                    <span class="tiggie-show-title margin-buttom-18 pr-4">
                        {{ props.plan?.name }}</span
                    >
                    <VChip color="teal">
                        {{ props.plan?.status }}
                    </VChip>
                ...
                <VCol cols="6">
                    <VRow>
                        <VCol cols="8">
                            ...
                            <p class="tiggie-p">
                                Allow access to basic features
                            </p>
                        </VCol>
                        <VCol cols="8">
                            <VLabel class="tiggie-label">Prices</VLabel>
                            <p class="tiggie-p">${{ props.plan?.price }}</p>
                        </VCol>
                    </VRow>
                </VCol>
                <VCol cols="6">
                    <VRow>
                        <VCol cols="8">
                            ...
                            >
                            <p class="tiggie-p">
                                {{ props.plan?.num_student_profiles }}
                            </p>
                        </VCol>
                        <VCol cols="8">
                            <VLabel class="tiggie-label">Storage space</VLabel>
                            <p class="tiggie-p">
                                {{ props.plan?.storage_limit }}GB
                            </p>
                        </VCol>
                        <VCol cols="8">
                            <VRow no-gutters>
                                <VCol cols="6">
                                    ...
                                    <p class="tiggie-p">
                                        {{
                                            props.plan?.allow_customisation
                                                ? "Yes"
                                                : "No"
                                        }}
                                    </p>
                                ...
                                <VCol cols="6">
                                    ...
                                    <p class="tiggie-p">
                                        {{
                                            props.plan?.allow_personalisation
                                                ? "Yes"
                                                : "No"
                                        }}
                                    </p>
                                ...
                                <VCol cols="6">
                                    ...
                                    <p class="tiggie-p">
                                        {{
                                            props.plan?.full_library_access
                                                ? "Yes"
                                                : "No"
                                        }}
                                    </p>
                                ...
                                <VCol cols="6">
                                    ...
                                    <p class="tiggie-p">
                                        {{
                                            props.plan?.weekly_learning_report
                                                ? "Yes"
                                                : "No"
                                        }}
                                    </p>
                                ...
                                <VCol cols="6">
                                    ...
                                    <p class="tiggie-p">
                                        {{
                                            props.plan?.dedicated_student_report
                                                ? "Yes"
                                                : "No"
                                        }}
                                    </p>
