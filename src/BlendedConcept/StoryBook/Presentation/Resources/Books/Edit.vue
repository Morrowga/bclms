      ...
      <v-card>
        ...
        <v-card-text class="px-10 py-0 pb-5">
          ...
          <div class="themes pt-2">
            ...
            <div class="d-flex">
              <v-chip-group>
                <div class="ps-relative" v-for="theme in form.themes" :key="theme.id">
                  <v-chip size="small"> {{theme.name}} </v-chip>
                  <div class="delete-chip">
                    <span>-</span>
                  </div>
                </div>
          ...
          <div class="supported pt-2">
            ...
            <div class="d-flex">
              <v-chip-group>
                <div class="ps-relative" v-for="device in form.devices" :key="device.id">
