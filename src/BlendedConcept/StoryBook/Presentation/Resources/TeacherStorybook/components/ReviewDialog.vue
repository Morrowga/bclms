      ...
      <VCard>
        <VCard-title>
          <div class="d-flex justify-space-between align-center">
            <span class="header-create ruddy-bold">Rage Our Book!</span>
            <v-btn
              variant="text"
              icon="mdi-close"
              @click="dialog = false"
        ...
        <VForm @submit.prevent="submitReview">
          <VCard-subtitle>
            <v-rating hover color="yellow" v-model="form.stars"></v-rating>
          </VCard-subtitle>
          <VCard-text>
            <VRow>
              <VCol cols="12">
                <VLabel class="required feedback-title pppangram-medium"
                  >Feedback</VLabel
                >
                <VTextarea placeholder="Enter Your Feedback Here" rows="10" v-model="form.feedback">
                </VTextarea>
              </VCol>
              <VCol cols="12" class="d-flex justify-center gap-10">
                <SecondaryBtn title="Cancel" />
                <v-btn variant="flat" rounded color="primary" width="200" type="submit">
                  Submit
                </v-btn>
              </VCol>
            </VRow>
