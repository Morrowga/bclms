                            ...
                            <v-col cols="12" md="6" class="pb-0">
                                <v-col cols="12" md="12">
                                    ...
                                    <VTextField
                                        ...
                                        density="compact"
                                        :rules="[requiredValidator]" :error-messages="form?.errors?.name"
                                    />
                                </v-col>
                            </v-col>
                            ...
                            <v-col cols="12" md="6" class="py-0">
                                <v-col cols="12" md="12">
                                    ...
                                    <v-autocomplete
                                        ...
                                        density="compact"
                                        :rules="[requiredValidator]" :error-messages="form?.errors?.disability_type_id"
                                    />
                                </v-col>
                            </v-col>
                            <v-col cols="12" md="6" class="py-0">
                            ...
                            <v-col cols="12" md="6" class="py-0 mt-5">
                                ...
                                <v-col cols="12" md="12">
                                    ...
                                    <div v-else>
                                        ...
                                        <div
                                        :rules="[requiredValidator]" :error-messages="form?.errors?.game"
                                        ></div>
                                    </div>
                                </v-col>
                                </v-col>
