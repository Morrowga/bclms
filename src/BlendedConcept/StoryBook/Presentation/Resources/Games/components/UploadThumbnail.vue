        ...
        <div>
            <VCard>
                <VForm ref="refForm" @submit.prevent="onFormSubmit">
                    <VCardText>
                        <p class="heading-upload-modal">Upload Game Thumbnail</p>
                        ...
                        >
                            <p v-if="!thumbnail" class="pppangram-normal" @click="handleFileInputClick">
                                Drag & Drop <strong class="colorprimary">.png/.jpg</strong> file here <br>
                                or <br>
                                Click to browser files
                            </p>
                            <div v-else>
                                <v-img :src="thumbnail" alt="Thumbnail" cover/>
                                <button @click="removeThumbnail" class="remove-button">Remove</button>
                            </div>
                            <input
