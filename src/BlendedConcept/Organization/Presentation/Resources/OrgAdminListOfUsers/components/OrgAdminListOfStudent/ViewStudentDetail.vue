...
let tab = ref(null);
const form = useForm({});
const props = defineProps(["organizations_student"]);
const deleteStudent = () => {
  isConfirmedDialog({
      ...
      <v-row>
        ...
        <v-col cols="12" md="6" class="pa-5">
              ...
              <Link
                :href="
                  route(
                    ...
                    organizations_student.student_id
                  )
                "
              >
                <v-btn
          ...
          <v-col cols="12">
            ...
            <p class="text-h6 font-weight-bold mx-4">
              {{ organizations_student.user.contact_number }}
            </p>
          </v-col>
          <v-col cols="12">
            <p class="text-subtitle-1 mb-0">Email Address</p>
            <p class="text-h6 font-weight-bold mx-4">
              {{ organizations_student.user.email }}
            </p>
          </v-col>
          <v-row>
            <v-col cols="12">
