                ...
                <VCol cols="6">
                    <VRow >
                        <VCol cols="8">
                            ...
                            <p class="tiggie-p">Allow access to basic features</p>
                        </VCol>
                        <VCol cols="8">
                            <VLabel class="tiggie-label">Prices</VLabel>
                            <p class="tiggie-p">$4.99</p>
                        </VCol>
                    </VRow>
                </VCol>
                <VCol cols="6">
