...
Route::middleware([
    ...
    Route::post('login', function (StoreLoginRequest $request) {
        ...
        if ($user) {
             ...
             *  is include in this organisation
             *
             */

            elseif ($user->organisation_id !== tenant()->organisation_id) {
    ...
    Route::get('/', [DashBoardController::class, 'superAdminDashboard'])->name('organisationaadmin')->middleware('auth');
