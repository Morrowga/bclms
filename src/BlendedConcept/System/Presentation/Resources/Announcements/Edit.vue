...
let props = defineProps(['organisations','announcement', 'b2cUsers', 'teachers', 'bcStaff']);
...
watch(searchIcon, (newSearchIcon) => {
  if (newSearchIcon.length === 0) {
    ...
    const filteredIcons = allIcons.value.filter((i) => i.includes(newSearchIcon));
                                            ...
                                            <VCol cols="12">
                                                <div class="text-center">
                                                    <div class="text-center">
                                                        ...
                                                        depressed
                                                        >
                                                            <v-icon :icon="'mdi-' + item" color="grey darken-3"> </v-icon>
                                                        </VBtn>
                                                    </div>
                                                </div>
                                            </VCol>
