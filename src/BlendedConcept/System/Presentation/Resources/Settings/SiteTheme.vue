            ...
            <VRow justify="center">
                    ...
                    <CustomizerSection title="Theming" :divider="false">
                        ...
                        <div class="d-flex gap-x-4 mt-2">
                            <div
                                ...
                                class="cursor-pointer d-flex align-center justify-center theme-style"
                                :class="{
                                    'elevation-4':
                ...
                <VCol cols="6">
                    <CustomizerSection title="Layout">
                        ...
                        <VRadioGroup v-model="form.content_with" inline>
                            <VRadio
                    ...
                    <CustomizerSection title="Menu">
                        ...
                        <VRadioGroup v-model="form.menu_type" inline>
                            <VRadio
                                v-for="[key, val] in Object.entries(
                                    AppContentLayoutNav
                                )"
