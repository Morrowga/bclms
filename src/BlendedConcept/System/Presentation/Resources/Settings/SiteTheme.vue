...
const secondaryColors = ["#FF8015","#FDE0CC","#D7DDF2","#F7BFC1",'#D7F2F0','#FFF2CE','#BFC0C1']
                ...
                <VCol cols="6">
                    <CustomizerSection title="Theming" :divider="false">
                        ...
                        <VRadioGroup v-model="theme" inline>
                            <VRadio v-for="themeOption in ['system', 'light', 'dark']" :key="themeOption"
                                :label="themeOption" :value="themeOption" class="text-capitalize" />
                        </VRadioGroup>
                        ...
                        <div class="d-flex gap-x-4 mt-2">
                            <div v-for="(color, index) in colors" :key="color" style="
                                ...
                                <VFadeTransition>
                                    <VIcon v-show="vuetifyTheme.current.value.colors.primary ===
                ...
                <VCol cols="6">
                    <CustomizerSection title="Layout">
                        ...
                        <VRadioGroup v-model="appContentWidth" inline>
                            <VRadio v-for="[key, val] in Object.entries(ContentWidth)" :key="key" :label="key"
                                :value="val" />
                        </VRadioGroup>
                        <!-- 👉 Navbar Type -->
                    ...
                    <CustomizerSection title="Menu">
                        ...
                        <VRadioGroup v-model="appContentLayoutNav" inline>
                            <VRadio v-for="[key, val] in Object.entries(AppContentLayoutNav)" :key="key" :label="key"
                                :value="val" />
                        </VRadioGroup>
                    </CustomizerSection>
