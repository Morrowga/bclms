    ...
    <AdminLayout>
        <VContainer>
            ...
            <VRow>
                <VCol cols="3">
                    <div>
                        <VImg src="/teacherdashboard/teacherimage.png" />
                    <div class="img-text-info mb-16">
                        <h4 class="text-white pl-8">Bravery</h4>
                        <p class="text-white pl-8">Assigned To:<span>Ethan Jonathan</span></p>
                    </div>
                    </div>
                ...
                <VCol cols="9">
                            ...
                            <VCard>
                                ...
                                <VCardItem>
                                    <VCardTitle class="text-center tiggie-teacher-p"
                                        style="color:#282828 !important;font-weight:700 !important">Influencing The
                                        Influencer
                                    </VCardTitle>
                                </VCardItem>
                                <VCardActions>
                    ...
                    <VRow justify="center">
                        <VCol cols="4">
                            <VBtn color="pale-blue" class="text-tiggie-blue" variant="flat" rounded>
                                Load More
                            </VBtn>
                        </VCol>
                    </VRow>
