<template>
    <div class="flex flex-wrap justify-center mt-3">
        <div class="w-6/12 sm:w-4/12 px-4 dropzone" >
            ...
            <button type="button" v-if="hasImage" @click="handleRemoveImage" class="flex items-center justify-center select-image">
...
function handleRemoveImage()
{
 ...
 imgArea.dataset.img = "";
 let img = document.createElement("img");
 img.src = "https://getstamped.co.uk/wp-content/uploads/WebsiteAssets/Placeholder.jpg"
 imgArea.appendChild(img);
