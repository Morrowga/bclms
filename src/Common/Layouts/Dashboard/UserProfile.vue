            ...
            <VList class="card-list mt-5">
              <VListItem class="py-3">
                <VListItemTitle class="text-sm">
                  <span class="font-weight-medium px-3">Username:</span>
              ...
              <VListItem class="pt-3">
                <VListItemTitle class="text-sm">
                  <span class="font-weight-medium px-3"> Email: </span>
                  <span class="text-body-2">{{
              ...
              <VListItem>
                <VListItemTitle class="text-sm">
                  <span class="font-weight-medium px-3"> Status: </span>
              ...
              <VListItem>
                <VListItemTitle class="text-sm">
                  <span class="font-weight-medium px-3">Role: </span>
              ...
              <VListItem>
                <VListItemTitle class="text-sm">
                  <span class="font-weight-medium px-3"> Contact: </span>
                  <span class="text-body-2">{{
