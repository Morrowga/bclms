...
<template #activator="{ props }">
    <VRow class="mt-8">
        <VCol cols="6" class="text-center">
            <v-btn
                ...
                width="200"
                height="100"
                class="rollbtn pppangram-bold"
                >Roll Once</v-btn
            >
            <div class="text-center">
                <span class="rolltext ruddy-bold"
                    >Spend <strong class="ruddy-bold">1 Gold Coin</strong></span
                >
            </div>
        </VCol>
        <VCol cols="6" class="text-center">
            <v-btn
                ...
                width="200"
                height="100"
                class="rollbtn mx-3 pppangram-bold"
                >Roll 10 Times</v-btn
            >
            <div class="text-center">
                <span class="rolltext ruddy-bold"
                    >Spend <strong class="ruddy-bold">8 Gold Coin</strong></span
                >
            </div>
        </VCol>
    </VRow>
        ...
        <VCard class="rolling-card">
            <VCardText>
                ...
                <div class="d-flex justify-center">
                    <span class="ruddy-bold rolling-text"
                        >Rolling for sticker</span
                    >
                </div>
            </VCardText>
        </VCard>
    ...
    <VDialog v-model="isInsufficientVisible" width="500">
        <VCard class="rolling-card">
            <VCardText>
                <div class="d-flex justify-center">
    ...
    <VDialog
        v-model="isRewardVisible"
        :width="currentTime == 1 ? '35%' : '70%'"
    >
        <!-- Activator -->
        <!-- <template #activator="{ props }">
        ...
        <VCard class="pa-16 rolling-card-result">
            ...
            <VCardText v-if="currentTime == 1">
                <div class="d-flex justify-center">
                    <v-img
                        :src="rolledData.image_url"
                        class="single-roll-img"
                        cover
                    ></v-img>
                </div>
                <div class="d-flex justify-center">
                    ...
                    <span
                        class="ruddy-bold rarity mt-4"
                        :class="rolledData.rarity"
                        >{{ rolledData.rarity }}</span
                    >
                    <v-img src="images/star.png" width="50" height="50"></v-img>
                </div>
                <div class="d-flex justify-center mt-3">
                    <span class="ruddy-bold stickername">{{
                        rolledData.name + " !"
                    }}</span>
                </div>
            </VCardText>
            ...
            <VCardText v-if="currentTime == 10">
                <VRow>
                    <VCol size="2" v-for="data in rolledData" :key="data.id">
                        ...
                        <div class="d-flex justify-center mt-3">
                            <span class="ruddy-bold stickername-multi">{{
                                data.name + " !"
                            }}</span>
                        </div>
                    </VCol>
