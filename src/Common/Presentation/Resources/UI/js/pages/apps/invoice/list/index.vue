    ...
    <section v-if="invoices">
        ...
        <VCard title="Filters" class="mb-6">
            <VCardText>
                <VRow>
                    <!-- 👉 Status filter -->
                    <VCol cols="12" md="6">
                        <VSelect v-model="selectedStatus" label="Select Status" clearable clear-icon="mdi-close"
                            :items="['Downloaded', 'Draft', 'Sent', 'Paid', 'Partial Payment', 'Past Due']" />
                    </VCol>

                    <!-- 👉 DateRange filter -->
                    <VCol cols="12" md="6">
                        <AppDateTimePicker v-model="dateRange" label="Invoice Date" clear-icon="mdi-close" clearable
                            :config="{ mode: 'range' }" />
                    </VCol>
                </VRow>
            </VCardText>
        ...
        <VCard id="invoice-list">
            <VCardText class="d-flex align-center flex-wrap gap-4">
                <!-- 👉 Actions  -->
                <div class="me-3">
                    <VSelect density="compact" label="Actions" :items="['Delete', 'Edit', 'Send']"
                        class="invoice-list-actions" :disabled="!selectedRows.length" />
                </div>
                ...
                <div class="d-flex align-center flex-wrap gap-4">
                    ...
                    <!-- 👉 Create invoice -->
                    <VBtn prepend-icon="mdi-plus" :to="{ name: 'apps-invoice-add' }">
                        Create invoice
                    </VBtn>
                </div>
            </VCardText>
            ...
            <VTable class="text-no-wrap table-header-bg rounded-0">
                    ...
                    <tr>
                        ...
                        <th scope="col" class="text-center">
                            <div style="width: 1rem;">
                                <VCheckbox :model-value="selectAllInvoice"
                ...
                <tbody>
                    <tr v-for="invoice in invoices" :key="invoice.id">
                        ...
                        <td>
                            <div class="d-flex align-center">
                                <VAvatar size="34"
                                    ...
                                    <span v-else class="text-sm">{{ avatarText(invoice.client.name) }}</span>
                                </VAvatar>
                        ...
                        <!-- 👉 Balance -->
                        <td class="text-center">
                            <VChip v-bind="resolveInvoiceBalanceVariant(invoice.balance, invoice.total).chip" size="small"
