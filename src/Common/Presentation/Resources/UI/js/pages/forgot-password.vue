...
const authV2ForgotPasswordMask = useGenerateImageVariant(
    authV2ForgotPasswordMaskLight,
    authV2ForgotPasswordMaskDark
);
const authV2ForgotPasswordIllustration = useGenerateImageVariant(
    ...
    <div>
        ...
        <VRow class="auth-wrapper" no-gutters>
            ...
            <VCol
                cols="12"
                md="4"
                class="auth-card-v2 d-flex align-center justify-center auth-card"
            >
