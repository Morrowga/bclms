        ...
        <div class="row">
            ...
            <div class="col-md-3 mt-4 me-2">
                <div class="panel panel-primary">
                    ...
                    {!! Form::open([
                        'route' => ['h5p.library.clear'],
                        'id' => 'laravel-h5p-update-content-type-cache',
                        'class' => 'form-horizontal',
                        'enctype' => 'multipart/form-data',
                    ]) !!}
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    ...
                                    <input type="checkbox" value="{{ $entry->restricted }}"
                                        @if ($entry->restricted == '1') checked="" @endif class="laravel-h5p-restricted"
                                        data-id="{{ $entry->id }}">
                                ...
                                <td class="text-center">
                                    <p class="form-control-static">
                                        {{ number_format($entry->getCountContentDependencies()) }}</p>
                                </td>
                                <td class="text-center">
                                    <p class="form-control-static">
                                        {{ number_format($entry->getCountLibraryDependencies()) }}</p>
                                </td>
