<template>
  <button :type="type" :class="dynamic_color" @click="clicked">
    {{ title }}
  </button>
</template>
<script setup>
...
let dynamic_color = computed(() => {
  switch (props.buttonColor) {
    ...
    case "blue":
      ...
      break;
    case "yellow":
      return "focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:focus:ring-yellow-900";
      break;
    case "red":
